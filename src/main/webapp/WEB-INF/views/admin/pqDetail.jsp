...
<!-- // 		var pqrepContent = exampleModal.find("textarea[name='content']"); -->
<!-- // 		var pqrepWriter = exampleModal.find("input[name='writer']"); -->
...
<!-- // 		//댓글 목록 보여주는 함수 -->
<!-- // 		function showList(pqnum){pqreplyService.getList(pqnum, function(list){ -->
<!-- // 				var htmls = ""; -->
				
<!-- // 				//댓글이 없을 경우 -->
<!-- // 				if(list == null || list.length == 0){ -->
<!-- // 					$("#pqreplyList").html("작성된 답변이 없습니다."); -->
<!-- // 					return; -->
<!-- // 				} -->
...
<!-- // 					htmls+=   '</div>' -->
<!-- // 					htmls+=	   '<p class="pqrepContent">'+list[i].content+'</p>' -->
<!-- // 					htmls+=  '</li>' -->
<!-- // 				} -->
<!-- // 				$("#pqreplyList").html(htmls); -->
<!-- // 			}); -->
<!-- // 		} //end showList -->
...
<!-- // 		$("#pqreplyList").on("click", "li", function(e){ -->
