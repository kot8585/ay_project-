		...
		<div class="col-lg-9">
			...
			<form name="f"
				...
				<div class="card-body">
					...
					<!--             가격 -->
					<h3>
						<script>numberWithCommas(${p.price })</script>
					</h3>
					...
					<h5>
						...
						<c:if test="${p.quantity == 0}">
							<input type="button" class="btn btn-danger" name="price"
								value="품절">
						</c:if>
						<c:if test="${p.quantity != 0}">
							<input type="submit" class="btn btn-danger" name="price"
								value="구매">
						</c:if>
						<input type="hidden" id="price" value="${p.price }"> <input
							type="hidden" name="p_num" id="p_num" value="${p.num }">
