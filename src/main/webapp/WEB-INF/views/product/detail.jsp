...
<body>
	...
	<form name="f"
		...
		<table border="1" cellspacing="0">
			<tr>
				<th>번호</th>
				<td><input type="text" name="p_num" id="p_num"
					value="${p.num }" readonly></td>
			</tr>
               ...
               등록된 이미지가 없습니다.
						...
						<table>
							...
							<tr>
								<td><img
									src="${pageContext.request.contextPath }/img?fname=${file0 }&num=${p.num }"
									class="img" width="50" height="50"></td>
								<td><img
			...
			<tr>
				...
				<input type="button" value="상품문의" onclick="go(${p.num})"></td>
			</tr>
		</table>
	</form>
